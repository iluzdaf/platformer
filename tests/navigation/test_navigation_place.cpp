...
TEST_CASE("A place on a path keeps the spot asked for", "[NavigationPlace]")
{
    ...
    REQUIRE(placeOnThePath(navigationGraph, {88.0f, 96.0f})->feet == glm::vec2(88.0f, 96.0f));
}
...
TEST_CASE("A place past the end of a path is the end of it", "[NavigationPlace]")
{
    ...
    REQUIRE(placeOnThePath(navigationGraph, {400.0f, 96.0f})->feet == glm::vec2(112.0f, 96.0f));
...
TEST_CASE("A place stays on the path it was asked about", "[NavigationPlace]")
{
    ...
    REQUIRE(placeOnThePath(navigationGraph, {72.0f, 96.0f})->feet.y == 96.0f);
    REQUIRE(placeOnThePath(navigationGraph, {72.0f, 128.0f})->feet.y == 128.0f);
}
...
TEST_CASE("A place asked for off every path falls to the path nearest it", "[NavigationPlace]")
{
    ...
    REQUIRE(placeOnThePath(navigationGraph, {64.0f, 32.0f})->feet == glm::vec2(64.0f, 96.0f));
    REQUIRE(placeOnThePath(navigationGraph, {400.0f, 32.0f})->feet == glm::vec2(112.0f, 96.0f));
}
...
TEST_CASE("A place can be partway up a climb", "[NavigationPlace]")
{
    ...
    REQUIRE(place);
    REQUIRE(place->feet == glm::vec2(16.0f, 64.0f));
}
...
TEST_CASE("A jump is not somewhere to stop partway", "[NavigationPlace]")
{
    ...
    REQUIRE(place);
    REQUIRE((place->feet == glm::vec2(0.0f, 192.0f) || place->feet == glm::vec2(96.0f, 96.0f)));
}
